...
<section class="bg-body-bg py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <h1 class="font-serif text-3xl md:text-4xl font-bold text-body-text">Risk Disclosure</h1>
        <div class="flex items-center justify-center gap-2 mt-3 text-sm text-body-muted">
            ...
            <span class="text-primary">Risk Disclosure</span>
        </div>
    </div>
</section>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
        <div class="bg-body-bg rounded-xl border border-body-border p-6 md:p-10">
            <div class="flex gap-3 mb-6">
                ...
                <a href="{{ route('risk') }}" class="text-sm font-medium bg-primary-subtle text-primary px-3 py-1 rounded-full hover:bg-primary hover:text-white transition">Risk Disclosure</a>
            </div>

            <article class="prose prose-sm max-w-none text-body-muted leading-relaxed space-y-6">
                <h3 class="text-xl font-bold text-body-text">RISK DISCLOSURE</h3>
