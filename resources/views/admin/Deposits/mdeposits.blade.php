...
@section('content')
    <x-admin.page-header title="Manage Deposits" subtitle="Review and process client deposit requests" />
                ...
                <tbody>
                    @foreach ($deposits as $deposit)
                        <tr>
                            ...
                            <td>{{ $deposit->created_at ? $deposit->created_at->toDayDateTimeString() : 'N/A' }}</td>
                            <td>
