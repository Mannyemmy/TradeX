...
<section class="bg-body-bg py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="text-center max-w-3xl mx-auto">
            ...
            <p class="text-body-muted text-lg mt-4"><?php echo e($settings->site_name); ?> offers access to several asset classes. Browse the categories below to see what you can trade on our platform.</p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-body-border p-6 hover:shadow-md transition group overflow-hidden">
                <div>
                    <div class="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style="background-color:<?php echo e($s['hex']); ?>20">
                        <svg class="w-5 h-5" style="color:<?php echo e($s['hex']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>
                    </div>
                    <h4 class="font-semibold text-body-text text-lg"><?php echo e($s['title']); ?></h4>
                    <p class="text-body-muted text-sm mt-2 leading-relaxed"><?php echo e($s['desc']); ?></p>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-body-muted mt-4 leading-relaxed">Our web-based platform is designed to be simple and transparent. Here is what you can expect when you trade with <?php echo e($settings->site_name); ?>.</p>
                <ul class="mt-6 space-y-3">
                    ...
                    <li class="flex items-start">
                        ...
                        <span class="text-body-muted text-sm ml-2"><?php echo e($f); ?></span>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            <div class="rounded-xl overflow-hidden shadow-sm border border-body-border">
                <img src="<?php echo e(asset('temp/frontpage/img/in-cirro-7-map.svg')); ?>" alt="Global Markets" class="w-full" />
            </div>
        </div>
    </div>
</section>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-body-border">
                    ...
                    <tr class="hover:bg-body-bg/50 transition">
                        <td class="py-3 px-4 font-semibold text-body-text"><?php echo e($share['name']); ?></td>
                        <td class="py-3 px-4 text-center"><span class="bg-primary-subtle text-primary text-xs px-2 py-0.5 rounded font-medium"><?php echo e($share['category']); ?></span></td>
                        <td class="py-3 px-4 text-center text-body-muted"><?php echo e($share['type']); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
        </div>
        <p class="text-body-muted text-xs mt-4 text-center">Trading CFDs involves risk. You may lose more than your initial deposit. Please read our <a href="<?php echo e(route('risk')); ?>" class="text-primary hover:underline">risk disclosure</a>.</p>
    </div>
</section>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Downloads\tradexpromaxnew-MYDIGITALMARKETHUB\resources\views/home/pricing.blade.php ENDPATH**/ ?>