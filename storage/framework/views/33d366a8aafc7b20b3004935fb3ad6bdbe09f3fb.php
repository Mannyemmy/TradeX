...
<?php $__env->startSection('title', 'Risk Warning'); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
        <div class="bg-body-bg rounded-xl border border-body-border p-6 md:p-10">
            <div class="flex gap-3 mb-6">
                <a href="<?php echo e(route('terms')); ?>" class="text-sm font-medium bg-primary-subtle text-primary px-3 py-1 rounded-full hover:bg-primary hover:text-white transition">Risk Warning</a>
                <a href="<?php echo e(route('privacy')); ?>" class="text-sm font-medium bg-body-bg text-body-muted px-3 py-1 rounded-full border border-body-border hover:text-primary transition">Privacy Policy</a>
            </div>
            ...
            <article class="prose prose-sm max-w-none text-body-muted leading-relaxed space-y-6">
                ...
                <p>There are risks associated with utilizing an Internet-based deal execution trading system including, but not limited to, the failure of hardware, software, and Internet connection. Since <?php echo e($settings->site_name); ?> does not control signal power, its reception or routing via Internet, configuration of your equipment or reliability of its connection, we cannot be responsible for communication failures, distortions or delays when trading via the Internet.</p>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Downloads\tradexpromaxnew-MYDIGITALMARKETHUB\resources\views/home/terms.blade.php ENDPATH**/ ?>