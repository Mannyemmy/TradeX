        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-xl shadow-sm border border-body-border p-6">
                    ...
                    <p class="text-body-muted text-sm"><?php echo e($settings->office ?? 'Our Office Address'); ?></p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-body-border p-6">
                    ...
                    <a href="mailto:<?php echo e($settings->contact_email); ?>" class="text-primary hover:underline text-sm"><?php echo e($settings->contact_email); ?></a>
                </div>
                    ...
                    <form method="POST" action="<?php echo e(route('enquiry')); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="w-full rounded-lg border border-body-border bg-body-bg px-4 py-2.5 text-sm text-body-text placeholder-body-muted focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition" placeholder="John Doe" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-body-text mb-1">Email Address <span class="text-red-500">*</span></label>
                                <input type="email" name="email" value="<?php echo e(old('email')); ?>" required class="w-full rounded-lg border border-body-border bg-body-bg px-4 py-2.5 text-sm text-body-text placeholder-body-muted focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition" placeholder="you@email.com" />
                            </div>
                        </div>
                        <div class="mt-5">
                            <label class="block text-sm font-medium text-body-text mb-1">Subject <span class="text-red-500">*</span></label>
                            <input type="text" name="subject" value="<?php echo e(old('subject')); ?>" required class="w-full rounded-lg border border-body-border bg-body-bg px-4 py-2.5 text-sm text-body-text placeholder-body-muted focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition" placeholder="How can we help?" />
                        </div>
                        <div class="mt-5">
                            <label class="block text-sm font-medium text-body-text mb-1">Message <span class="text-red-500">*</span></label>
                            <textarea name="message" rows="5" required class="w-full rounded-lg border border-body-border bg-body-bg px-4 py-2.5 text-sm text-body-text placeholder-body-muted focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition resize-y" placeholder="Your message..."><?php echo e(old('message')); ?></textarea>
                        </div>
                        <?php if($settings->captcha_status ?? false): ?>
                        <div class="mt-5">
                            <label class="block text-sm font-medium text-body-text mb-1">Captcha <span class="text-red-500">*</span></label>
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e(captcha_src()); ?>" alt="captcha" class="rounded" />
...
<section class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="rounded-xl overflow-hidden border border-body-border shadow-sm">
            <iframe src="https://maps.google.com/maps?q=<?php echo e(urlencode($settings->office ?? '')); ?>&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Downloads\tradexpromaxnew-MYDIGITALMARKETHUB\resources\views/home/contact.blade.php ENDPATH**/ ?>