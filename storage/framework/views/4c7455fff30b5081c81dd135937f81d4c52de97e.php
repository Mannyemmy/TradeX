...
<div x-data="{
    ...
    class="fixed inset-0 z-50 px-4 py-6 overflow-y-auto jetstream-modal sm:px-0 w-100" style="display: none;">
    ...
    <div x-show="show"
        class="mb-6 overflow-hidden transition-all transform bg-white rounded-lg shadow-xl sm:w-full w-100 sm:mx-auto"
...
<?php /**PATH C:\Users\DELL\Downloads\tradexpromaxnew-MYDIGITALMARKETHUB\resources\views/vendor/jetstream/components/modal.blade.php ENDPATH**/ ?>