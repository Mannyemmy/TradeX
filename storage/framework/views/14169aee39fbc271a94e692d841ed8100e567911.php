    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div class="lg:col-span-5">
                <h1 class="font-serif text-3xl md:text-4xl font-bold text-body-text leading-tight">About <?php echo e($settings->site_name); ?></h1>
                <p class="text-body-muted text-lg mt-4 leading-relaxed">
                    <?php echo e($settings->site_name); ?> is an online trading platform providing access to forex, cryptocurrency, commodities and stock CFD markets. We aim to offer transparent pricing, reliable order execution and a straightforward user experience.
                </p>
            ...
            <div class="lg:col-span-7 relative">
                <img src="<?php echo e(asset('temp/frontpage/img/in-cirro-7-map.svg')); ?>" alt="Global reach" class="w-full" />
...
<section class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="text-center max-w-3xl mx-auto mb-12">
            ...
            <p class="text-body-muted text-lg mt-3">We built <?php echo e($settings->site_name); ?> around three principles: transparency, reliability and accessibility.</p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="flex items-start">
                <div class="w-12 h-12 rounded-lg bg-primary flex items-center justify-center flex-shrink-0 mr-4">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($v['icon']); ?>"/></svg>
                </div>
                <div>
                    <h3 class="text-lg font-semibold text-body-text"><?php echo e($v['title']); ?></h3>
                    <p class="text-body-muted text-sm mt-2 leading-relaxed"><?php echo e($v['desc']); ?></p>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="text-center">
                <img src="<?php echo e(asset('temp/frontpage/img/' . $o['icon'])); ?>" alt="<?php echo e($o['label']); ?>" class="w-16 h-16 mx-auto" />
                <h6 class="text-sm font-semibold text-body-text mt-3"><?php echo e($o['label']); ?></h6>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="text-center lg:text-left">
                ...
                <a href="<?php echo e(route('risk')); ?>" class="inline-flex items-center mt-4 bg-primary hover:bg-primary-dark text-white font-semibold rounded-lg px-6 py-3 text-sm transition">
            ...
            <div class="bg-body-bg rounded-xl border border-body-border p-6">
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-start">
                        ...
                        <span class="text-body-muted text-sm ml-2"><?php echo e($af); ?></span>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Downloads\tradexpromaxnew-MYDIGITALMARKETHUB\resources\views/home/about.blade.php ENDPATH**/ ?>