...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        try {
            ...
            // Database not ready / not yet migrated — skip runtime config wiring.
            return;
        }

        // Without a settings row there is nothing to wire up; bail gracefully
        // instead of fatally dereferencing nulls.
