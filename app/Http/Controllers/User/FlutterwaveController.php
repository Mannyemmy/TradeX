...
class FlutterwaveController extends Controller
{
    ...
    public function callback()
    {
        ...
        try {
            ...
            Log::error('Flutterwave deposit email failed: ' . $e->getMessage());
        }

        \App\Services\NotificationService::notifyUser($user, 'deposit', 'Deposit Confirmed', 'Your deposit of $' . number_format($dp->amount, 2) . ' via Flutterwave has been confirmed.', url('dashboard/deposits'));
