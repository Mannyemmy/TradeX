...
class PaystackController extends Controller
{
    ...
    public function handleGatewayCallback()
    {
        ...
        \App\Services\NotificationService::notifyUser($user, 'deposit', 'Deposit Confirmed', 'Your deposit of $' . number_format($dp->amount, 2) . ' via Paystack has been confirmed.', url('dashboard/deposits'));
